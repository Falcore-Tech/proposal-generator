  ...
  return (
    <Section>
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% 0%, oklch(from var(--accent) l c h / 0.4) 0%, transparent 70%)",
          zIndex: "var(--z-bg)",
        }}
      />
      ...
      >
        ...
        <MetaChip
          label="Date"
          value={new Date(proposal.proposal_date).toLocaleDateString("en-AE", {
            year: "numeric",
            month: "long",
            day: "numeric",
          })}
