...
export const termsAndConditions = [
  ...
  "7. Confidentiality: Falcore agrees to maintain confidentiality of all client information.",
  ...
  "10. Commencement of Ad Management: The initial ad management period (1 month) will begin once all essential assets—including CRM access, video creatives, and static visuals—have been delivered and approved. Ongoing management beyond this period will require enrollment in one of Falcore's subscription packages.",
  "11. Advertising Platforms: Falcore can manage advertising across any major platform. Platform selection is based on the client's budget and marketing strategy, with common starting points being Google Ads and Meta platforms.",
  "12. Ad Spend Handling: Ad budgets will be actively managed by Falcore. However, all payments for ad spend will be made directly by the client through their own advertising account(s).",
  "13. CRM Usage Terms: If a client chooses not to continue with a subscription plan after the initial engagement but wishes to retain CRM access, a fee of AED 300 per month will apply. This fee is included at no extra cost for clients on a subscription plan.",
  "14. Ownership of Data and Assets: All CRM data, leads, and creative assets produced for the client remain the exclusive property of the client. Upon request, a Non-Disclosure Agreement (NDA) may be signed. In the case of a full refund under our satisfaction guarantee, ownership of all deliverables reverts to Falcore and use of such content is no longer permitted.",
  "15. Optimization Commitment: Campaigns managed during the initial period will be actively optimized for performance, with the goal of delivering meaningful results and building a strong foundation for long-term collaboration.",
  "16. Delivery of Assets and Reports: All final assets and reports will be shared with the client upon completion and internal approval, ensuring transparency and full access.",
  "17. Support Response Time: Falcore provides customer support within 12–24 hours on business days, with most queries addressed much sooner.",
  "18. Reporting & Review Rights: Clients under ongoing management plans are entitled to request weekly performance reports or biweekly review meetings with their assigned account manager.",
  "19. Ad Account Access and Control: Advertising accounts will be created and owned by the client. Falcore will be granted access as an employee or partner for campaign management purposes only.",
  "20. Creative Revisions: All ad creatives will be uniquely tailored to the client's brand and may undergo revisions until satisfactory, within reasonable limits as defined in the package.",
  "21. Project Handover and Exit Support: If a client chooses not to continue with Falcore's services post-project, a full handover will be provided, along with two weeks of standby support to assist with the transition.",
];
